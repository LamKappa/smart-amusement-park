 ...
 * @Version  1.0
 * @Autor  yuchen
 * @Date  2021-09-09 14:08:37
 * @LastEditors  yuchen
 * @LastEditTime  2021-09-18 15:20:03
 */
/*
...
hi_void app_io_init(hi_void)
{
    ...
    /* uart1 AT命令串口 */
    hi_io_set_func(HI_IO_NAME_GPIO_1, HI_IO_FUNC_GPIO_5_UART1_RXD); /* uart1 rx */
    hi_io_set_func(HI_IO_NAME_GPIO_0, HI_IO_FUNC_GPIO_6_UART1_TXD); /* uart1 tx */
#endif
