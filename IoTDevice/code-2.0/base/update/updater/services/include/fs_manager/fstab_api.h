...
#ifndef __UPDATER_FS_MANAGER_FSTAB_API_H
#define __UPDATER_FS_MANAGER_FSTAB_API_H
#include <string>
#include "fs_manager/fstab.h"

namespace updater {
bool ReadFstabFromFile(const std::string &fstabFile, Fstab &fstabs);
...
#endif // __UPDATER_FS_MANAGER_FSTAB_API_
