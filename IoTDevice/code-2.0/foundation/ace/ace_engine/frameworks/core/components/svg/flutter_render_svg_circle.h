...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_CIRCLE_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_CIRCLE_H
...
class FlutterRenderSvgCircle : public RenderSvgCircle {
    DECLARE_ACE_TYPE(FlutterRenderSvgCircle, RenderSvgCircle);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_CIRCLE_H
