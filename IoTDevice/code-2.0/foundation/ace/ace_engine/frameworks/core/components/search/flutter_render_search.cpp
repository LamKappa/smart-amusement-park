...
void FlutterRenderSearch::PaintFocus()
{
...
void FlutterRenderSearch::PaintOverlayForHoverAndPress(RenderContext& context, const Offset& offset)
{
...
SkRRect FlutterRenderSearch::MakeRRect(const Offset& offset, const Size& size, const Border& border)
{
...
SkCanvas* FlutterRenderSearch::GetSkCanvas(RenderContext& context)
{
