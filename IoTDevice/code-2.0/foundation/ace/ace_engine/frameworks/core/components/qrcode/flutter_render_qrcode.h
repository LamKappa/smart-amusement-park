...
class FlutterRenderQrcode : public RenderQrcode {
    DECLARE_ACE_TYPE(FlutterRenderQrcode, RenderQrcode);
...
public:
    FlutterRenderQrcode() = default;
    ~FlutterRenderQrcode() override = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_QRCODE_FLUTTER_RENDER_QRCODE_H
