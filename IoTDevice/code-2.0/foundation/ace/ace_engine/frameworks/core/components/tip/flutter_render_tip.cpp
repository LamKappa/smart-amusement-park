...
#include "core/components/tip/flutter_render_tip.h"
...
SkCanvas* FlutterRenderTip::GetSkCanvas(RenderContext& context)
{
...
void FlutterRenderTip::PaintTip(RenderContext& context, const Offset& offset)
{
