...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_ELLIPSE_H
...
class FlutterRenderSvgEllipse : public RenderSvgEllipse {
    DECLARE_ACE_TYPE(FlutterRenderSvgEllipse, RenderSvgEllipse);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_ELLIPSE_H
