...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_ANIMATION_SVG_SHARP_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_ANIMATION_SVG_SHARP_H

#include "frameworks/core/components/common/properties/svg_paint_state.h"

namespace OHOS::Ace {

class ACE_EXPORT SvgSharp : public AceType {
    DECLARE_ACE_TYPE(SvgSharp, AceType);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_ANIMATION_SVG_SHARP_H
