...
constexpr double TEXT_FIELD_STYLE_WORD_SPACING = 10.0;
constexpr double TEXT_FIELD_STYLE_WORD_SPACING_DEFAULT = 0.0;
constexpr double TEXT_FIELD_STYLE_LETTER_SPACING = 10.0;
constexpr double TEXT_FIELD_STYLE_LETTER_SPACING_DEFAULT = 0.0;
...
HWTEST_F(TextFieldStyleCreatorTest, TextFieldStyleCreator001, TestSize.Level1)
{
    ...
    EXPECT_TRUE(NearEqual(textStyle.GetWordSpacing(), TEXT_FIELD_STYLE_WORD_SPACING));
    EXPECT_TRUE(NearEqual(textStyle.GetLetterSpacing(), TEXT_FIELD_STYLE_LETTER_SPACING));
...
HWTEST_F(TextFieldStyleCreatorTest, TextFieldStyleCreator002, TestSize.Level1)
{
    ...
    EXPECT_TRUE(NearEqual(textStyle.GetWordSpacing(), TEXT_FIELD_STYLE_WORD_SPACING_DEFAULT));
    EXPECT_TRUE(NearEqual(textStyle.GetWordSpacing(), TEXT_FIELD_STYLE_LETTER_SPACING_DEFAULT));
