...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_RECT_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_RECT_H

#include "frameworks/core/components/svg/render_svg_rect.h"
#include "frameworks/core/pipeline/layers/opacity_layer.h"
#include "frameworks/core/pipeline/layers/transform_layer.h"

namespace OHOS::Ace {

class FlutterRenderSvgRect : public RenderSvgRect {
    DECLARE_ACE_TYPE(FlutterRenderSvgRect, RenderSvgRect);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_RECT_H
