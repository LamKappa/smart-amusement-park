...
#ifndef FOUNDATION_AAFWK_SERVICES_TOOLS_AA_INCLUDE_SHELL_COMMAND_H
#define FOUNDATION_AAFWK_SERVICES_TOOLS_AA_INCLUDE_SHELL_COMMAND_H
...
#endif  // FOUNDATION_AAFWK_SERVICES_TOOLS_AA_INCLUDE_SHELL_COMMAND_H