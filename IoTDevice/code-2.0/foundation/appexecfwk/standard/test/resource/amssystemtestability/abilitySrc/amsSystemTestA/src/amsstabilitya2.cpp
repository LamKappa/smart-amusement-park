...
#include "amsstabilitya2.h"

namespace OHOS {
namespace AppExecFwk {
void AmsStAbilityA2::OnStart(const Want &want)
{
    GetWantInfo(want);

    APP_LOGI("AmsStAbilityA2::onStart");
...
void AmsStAbilityA2::OnForeground(const Want &want)
{
    GetWantInfo(want);

    APP_LOGI("AmsStAbilityA2::OnForeground");
...
void AmsStAbilityA2::OnNewWant(const Want &want)
{
    GetWantInfo(want);

    APP_LOGI("AmsStAbilityA2::OnNewWant");
...
void AmsStAbilityA2::OnStop()
{
    APP_LOGI("AmsStAbilityA2::onStop");
    Ability::OnStop();
...
void AmsStAbilityA2::OnActive()
{
    APP_LOGI("AmsStAbilityA2::OnActive");
    Ability::OnActive();
...
void AmsStAbilityA2::OnInactive()
{
    APP_LOGI("AmsStAbilityA2::OnInactive");
    Ability::OnInactive();
...
void AmsStAbilityA2::OnBackground()
{
...
void AmsStAbilityA2::GetWantInfo(const Want &want)
{
    Want mWant(want);
