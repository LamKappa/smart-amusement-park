...
void AmsStAbilityE1::OnStart(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityE1::onStart");
...
void AmsStAbilityE1::OnForeground(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityE1::OnForeground");
...
void AmsStAbilityE1::OnNewWant(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityE1::OnNewWant");
...
{
    APP_LOGI("AmsStAbilityE1::onStop");
    Ability::OnStop();
...
{
    APP_LOGI("AmsStAbilityE1::OnActive");
    Ability::OnActive();
...
{
    APP_LOGI("AmsStAbilityE1::OnInactive");
    Ability::OnInactive();
...
{
    APP_LOGI("AmsStAbilityE1::OnBackground");
