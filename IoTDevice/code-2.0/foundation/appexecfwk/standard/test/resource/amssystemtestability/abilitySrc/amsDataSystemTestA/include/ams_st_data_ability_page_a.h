 ...
 */
#ifndef AMS_ST_DATA_ABILITY_PAGE_A_H
#define AMS_ST_DATA_ABILITY_PAGE_A_H
#include <vector>
#include <string>
...
class DataTestPageAEventSubscriber;

class AmsStDataAbilityPageA : public Ability {
public:
...
private:
    ...
    Want originWant_;
    std::shared_ptr<DataTestPageAEventSubscriber> subscriber_;
};

class AmsStDataAbilityPageALifecycleObserver : public ILifecycleObserver {
public:
    AmsStDataAbilityPageALifecycleObserver() = default;
    virtual ~AmsStDataAbilityPageALifecycleObserver() = default;
...
class DataTestPageAEventSubscriber : public CommonEventSubscriber {
public:
    DataTestPageAEventSubscriber(const CommonEventSubscribeInfo &sp, AmsStDataAbilityPageA *ability)
    ...
    AmsStDataAbilityPageA *mainAbility_;
    std::unordered_map<std::string, std::function<void()>> mapTestFunc_;
    ~DataTestPageAEventSubscriber(){};
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // AMS_ST_DATA_ABILITY_PAGE_A_H