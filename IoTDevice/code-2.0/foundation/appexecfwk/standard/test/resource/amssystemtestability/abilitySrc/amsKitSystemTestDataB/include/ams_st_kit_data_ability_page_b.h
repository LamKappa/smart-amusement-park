 ...
 */
#ifndef AMS_ST_KIT_DATA_ABILITY_PAGE_B_H
#define AMS_ST_KIT_DATA_ABILITY_PAGE_B_H
#include <string>
#include <vector>
...
private:
    ...
    Want originWant_;
    std::shared_ptr<KitTestPageBEventSubscriber> subscriber_;
};

class KitTestPageBEventSubscriber : public CommonEventSubscriber {
public:
    ...
    AmsStKitDataAbilityPageB *mainAbility_;
    std::unordered_map<std::string, std::function<void()>> mapTestFunc_;
    ~KitTestPageBEventSubscriber(){};
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // AMS_ST_KIT_DATA_ABILITY_PAGE_B_H