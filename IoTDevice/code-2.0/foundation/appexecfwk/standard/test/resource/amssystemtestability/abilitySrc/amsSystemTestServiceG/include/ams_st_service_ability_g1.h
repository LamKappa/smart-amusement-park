...
#ifndef AMS_ST_SERVICE_ABILITY_G1_
#define AMS_ST_SERVICE_ABILITY_G1_
...
const std::string APP_G1_RESP_EVENT_NAME = "resp_com_ohos_amsst_service_app_g1";
const std::string APP_G1_REQ_EVENT_NAME = "req_com_ohos_amsst_service_app_g1";
class AmsStServiceAbilityG1 : public Ability {
public:
...
private:
    ...
    typedef void (AmsStServiceAbilityG1::*func)();
    ...
    public:
            ...
            const AppExecFwk::ElementName &element, const sptr<IRemoteObject> &remoteObject, int resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(APP_G1_RESP_EVENT_NAME, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(APP_G1_RESP_EVENT_NAME, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        AmsStServiceAbilityG1 *mainAbility_ = nullptr;
    };
...
#endif  // AMS_ST_SERVICE_ABILITY_G1_