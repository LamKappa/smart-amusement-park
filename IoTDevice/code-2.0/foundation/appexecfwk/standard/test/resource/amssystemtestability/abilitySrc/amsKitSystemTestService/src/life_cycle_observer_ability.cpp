...
{
    TestUtils::PublishEvent(APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, 0, "OnAbilityStart");
}

void LifecycleObserverLifecycleCallbacks::OnAbilityInactive(const std::shared_ptr<Ability> &ability)
{
    TestUtils::PublishEvent(APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, 0, "OnAbilityInactive");
}

void LifecycleObserverLifecycleCallbacks::OnAbilityBackground(const std::shared_ptr<Ability> &ability)
{
    TestUtils::PublishEvent(APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, 0, "OnAbilityBackground");
}

void LifecycleObserverLifecycleCallbacks::OnAbilityForeground(const std::shared_ptr<Ability> &ability)
{
    TestUtils::PublishEvent(APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, 0, "OnAbilityForeground");
}

void LifecycleObserverLifecycleCallbacks::OnAbilityActive(const std::shared_ptr<Ability> &ability)
{
    TestUtils::PublishEvent(APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, 0, "OnAbilityActive");
}

void LifecycleObserverLifecycleCallbacks::OnAbilityStop(const std::shared_ptr<Ability> &ability)
{
    TestUtils::PublishEvent(APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, 0, "OnAbilityStop");
}

void LifecycleObserverLifecycleCallbacks::OnAbilitySaveState(const PacMap &outState)
{
    TestUtils::PublishEvent(APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, 0, "OnAbilitySaveState");
}
...
void LifeCycleObserverAbility::OnStart(const Want &want)
{
    ...
    TestUtils::PublishEvent(
        APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, AbilityLifecycleExecutor::LifecycleState::INACTIVE, "OnStart");
...
void LifeCycleObserverAbility::OnStop()
{
    ...
    BaseAbility::OnStop();
    TestUtils::PublishEvent(
        APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, AbilityLifecycleExecutor::LifecycleState::INITIAL, "OnStop");
...
void LifeCycleObserverAbility::OnActive()
{
    ...
    TestUtils::PublishEvent(
        APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, AbilityLifecycleExecutor::LifecycleState::ACTIVE, "OnActive");
...
void LifeCycleObserverAbility::OnInactive()
{
    ...
    TestUtils::PublishEvent(
        APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, AbilityLifecycleExecutor::LifecycleState::INACTIVE, "OnInactive");
...
void LifeCycleObserverAbility::OnBackground()
{
    ...
    TestUtils::PublishEvent(
        APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, AbilityLifecycleExecutor::LifecycleState::BACKGROUND, "OnBackground");
...
void LifeCycleObserverAbility::OnForeground(const Want &want)
{
    ...
    BaseAbility::OnBackground();
    TestUtils::PublishEvent(
        APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, AbilityLifecycleExecutor::LifecycleState::INACTIVE, "OnForeground");
...
void LifeCycleObserverAbility::OnCommand(const Want &want, bool restart, int startId)
{
    ...
    TestUtils::PublishEvent(
        APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, AbilityLifecycleExecutor::LifecycleState::ACTIVE, "OnCommand");
...
sptr<IRemoteObject> LifeCycleObserverAbility::OnConnect(const Want &want)
{
    ...
    TestUtils::PublishEvent(
        APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, AbilityLifecycleExecutor::LifecycleState::ACTIVE, "OnConnect");
...
void LifeCycleObserverAbility::OnDisconnect(const Want &want)
{
    ...
    TestUtils::PublishEvent(
        APP_LIFE_CYCLE_OBSERVER_RESP_EVENT_NAME, AbilityLifecycleExecutor::LifecycleState::BACKGROUND, "OnDisconnect");
