...
#ifndef AMS_ST_SERVICE_ABILITY_A1_
...
const std::string APP_A1_RESP_EVENT_NAME = "resp_com_ohos_amsst_service_app_a1";
const std::string APP_A1_REQ_EVENT_NAME = "req_com_ohos_amsst_service_app_a1";

class AmsStServiceAbilityA1 : public Ability {
public:
...
private:
    ...
    typedef void (AmsStServiceAbilityA1::*func)();
    ...
    public:
        ...
        AmsStServiceAbilityA1 *mainAbility_ = nullptr;
    };
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // AMS_ST_SERVICE_ABILITY_A1_