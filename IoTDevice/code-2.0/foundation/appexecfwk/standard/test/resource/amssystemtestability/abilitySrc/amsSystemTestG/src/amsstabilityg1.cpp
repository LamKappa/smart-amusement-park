...
void AmsStAbilityG1::OnStart(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityG1::onStart");
...
void AmsStAbilityG1::OnNewWant(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityG1::OnNewWant");
...
void AmsStAbilityG1::OnForeground(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityG1::OnForeground");
...
{
    APP_LOGI("AmsStAbilityG1::onStop");
    Ability::OnStop();
...
{
    APP_LOGI("AmsStAbilityG1::OnActive");
    Ability::OnActive();
...
{
    APP_LOGI("AmsStAbilityG1::OnInactive");
    Ability::OnInactive();
...
{
    APP_LOGI("AmsStAbilityG1::OnBackground");
