...
void AmsStAbilityD2::OnStart(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityD2::onStart");
...
void AmsStAbilityD2::OnForeground(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityD2::OnForeground");
...
void AmsStAbilityD2::OnNewWant(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityD2::OnNewWant");
...
{
    APP_LOGI("AmsStAbilityD2::onStop");
    Ability::OnStop();
...
{
    APP_LOGI("AmsStAbilityD2::OnActive");
    Ability::OnActive();
...
{
    APP_LOGI("AmsStAbilityD2::OnInactive");
    Ability::OnInactive();
...
{
    APP_LOGI("AmsStAbilityD2::OnBackground");
