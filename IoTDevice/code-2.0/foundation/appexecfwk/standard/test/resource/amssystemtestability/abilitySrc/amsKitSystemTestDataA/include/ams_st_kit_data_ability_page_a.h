 ...
 */
#ifndef AMS_ST_KIT_DATA_ABILITY_PAGE_A_H
#define AMS_ST_KIT_DATA_ABILITY_PAGE_A_H
#include <string>
#include <vector>
...
private:
    ...
    Want originWant_;
    std::shared_ptr<KitTestPageAEventSubscriber> subscriber_;
};

class KitTestPageAEventSubscriber : public CommonEventSubscriber {
public:
    KitTestPageAEventSubscriber(const CommonEventSubscribeInfo &sp, AmsStKitDataAbilityPageA *ability)
...
#endif  // AMS_ST_KIT_DATA_ABILITY_PAGE_A_H