...
const std::string APP_H1_RESP_EVENT_NAME = "resp_com_ohos_amsst_service_app_h1";
const std::string APP_H1_REQ_EVENT_NAME = "req_com_ohos_amsst_service_app_h1";
class AmsStServiceAbilityH1 : public Ability {
public:
...
private:
    ...
    typedef void (AmsStServiceAbilityH1::*func)();
    ...
    public:
            ...
            const AppExecFwk::ElementName &element, const sptr<IRemoteObject> &remoteObject, int resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(APP_H1_RESP_EVENT_NAME, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(APP_H1_RESP_EVENT_NAME, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        AmsStServiceAbilityH1 *mainAbility_ = nullptr;
    };
