...
private:
    Want originWant_;
    std::shared_ptr<DataTestDataC2EventSubscriber> subscriber_;
};

class DataTestDataC2EventSubscriber : public CommonEventSubscriber {
public:
    DataTestDataC2EventSubscriber(const CommonEventSubscribeInfo &sp, AmsStDataAbilityDataC2 *ability)
    ...
    AmsStDataAbilityDataC2 *mainAbility_;
