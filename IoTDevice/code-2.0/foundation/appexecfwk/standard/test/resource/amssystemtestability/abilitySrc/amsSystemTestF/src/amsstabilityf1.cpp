...
#include "amsstabilityf1.h"

namespace OHOS {
namespace AppExecFwk {
void AmsStAbilityF1::OnStart(const Want &want)
{
    GetWantInfo(want);

    APP_LOGI("AmsStAbilityF1::onStart");
...
void AmsStAbilityF1::OnForeground(const Want &want)
{
    GetWantInfo(want);

    APP_LOGI("AmsStAbilityF1::OnForeground");
...
void AmsStAbilityF1::OnNewWant(const Want &want)
{
    GetWantInfo(want);

    APP_LOGI("AmsStAbilityF1::OnNewWant");
...
void AmsStAbilityF1::OnStop()
{
    APP_LOGI("AmsStAbilityF1::onStop");
    Ability::OnStop();
...
void AmsStAbilityF1::OnActive()
{
    APP_LOGI("AmsStAbilityF1::OnActive");
    Ability::OnActive();
...
void AmsStAbilityF1::OnInactive()
{
    APP_LOGI("AmsStAbilityF1::OnInactive");
    Ability::OnInactive();
...
void AmsStAbilityF1::OnBackground()
{
    APP_LOGI("AmsStAbilityF1::OnBackground");
...
void AmsStAbilityF1::GetWantInfo(const Want &want)
{
    Want mWant(want);
