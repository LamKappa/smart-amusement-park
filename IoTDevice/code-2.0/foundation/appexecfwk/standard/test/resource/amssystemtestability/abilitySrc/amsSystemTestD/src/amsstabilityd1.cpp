...
void AmsStAbilityD1::OnStart(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityD1::onStart");
...
void AmsStAbilityD1::OnForeground(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityD1::OnForeground");
...
void AmsStAbilityD1::OnNewWant(const Want &want)
{
    ...
    APP_LOGI("AmsStAbilityD1::OnNewWant");
...
{
    APP_LOGI("AmsStAbilityD1::onStop");
    Ability::OnStop();
...
{
    APP_LOGI("AmsStAbilityD1::OnActive");
    Ability::OnActive();
...
{
    APP_LOGI("AmsStAbilityD1::OnInactive");
    Ability::OnInactive();
...
{
    APP_LOGI("AmsStAbilityD1::OnBackground");
