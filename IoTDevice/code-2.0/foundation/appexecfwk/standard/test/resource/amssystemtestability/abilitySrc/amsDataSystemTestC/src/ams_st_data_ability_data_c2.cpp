...
int AmsStDataAbilityDataC2::Insert(const Uri &uri, const ValuesBucket &value)
{
...
int AmsStDataAbilityDataC2::Delete(const Uri &uri, const DataAbilityPredicates &predicates)
{
...
int AmsStDataAbilityDataC2::Update(const Uri &uri, const ValuesBucket &value, const DataAbilityPredicates &predicates)
{
...
std::shared_ptr<ResultSet> AmsStDataAbilityDataC2::Query(
